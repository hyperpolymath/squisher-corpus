...
// Replace squisher-corpus, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= squisher-corpus — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining squisher-corpus for
...
podman build -t squisher-corpus .
----
...
* Upstream: https://github.com/hyperpolymath/squisher-corpus/issues
