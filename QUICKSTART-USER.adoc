...
// Replace squisher-corpus, Squisher Corpus — See README.adoc for details., just run, Squisher Corpus started successfully. with actuals
= squisher-corpus — Quick Start for Users
:toc:
:toclevels: 2

== What is squisher-corpus?

Squisher Corpus — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./squisher-corpus-portable
----
...
[source]
----
Squisher Corpus started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/squisher-corpus/wiki
