...
doctor:
    @echo "Running diagnostics for squisher-corpus..."
...
help-me:
    @echo "=== squisher-corpus Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/squisher-corpus/issues/new"
    @echo ""
